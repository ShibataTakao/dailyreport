			...
			},
			{
				...
				Flags: []cli.Flag{
					&cli.StringFlag{
						...
						Required: true,
						EnvVars:  []string{"DR_REPORT_CATEGORY"},
					},
					&cli.StringFlag{
						Name:     "start-date",
						Aliases:  []string{"s"},
						...
						Required: true,
						EnvVars:  []string{"DR_REPORT_START_DATE"},
					},
					&cli.StringFlag{
						Name:     "end-date",
						Aliases:  []string{"e"},
						...
						Required: true,
						EnvVars:  []string{"DR_REPORT_END_DATE"},
					},
					&cli.StringFlag{
						Name:     "backlog-api-key",
						Usage:    "Backlog api key",
						Required: true,
						EnvVars:  []string{"DR_BACKLOG_API_KEY"},
					},
					&cli.StringFlag{
					...
					&cli.StringFlag{
						...
						Required: true,
						EnvVars:  []string{"DR_BACKLOG_QUERIES"},
					},
				},
				Action: func(c *cli.Context) error {
